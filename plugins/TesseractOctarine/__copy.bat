...
md ..\..\build\plugins\Tesseract.Octarine\tessdata 2>nul
...
copy /y tessdata\*.ttf ..\..\build\plugins\Tesseract.Octarine\tessdata\*
copy /y tessdata\*.traineddata ..\..\build\plugins\Tesseract.Octarine\tessdata\*